...
import { Agent, Environment, Arena, LocalProvider, Human, Conversation, HumanProvider } from "./src/lib";
import Orchestrator from "./src/lib/Orchestrator";

const localprovider = new LocalProvider("deepseek-llm-7b-chat.Q4_K_M", `http://127.0.0.1:${8081}/v1/chat/completions`);
const humanProvider = new HumanProvider();
...
const conversation = new Conversation(
    [
        ceo,
        player1, player2, player3, player4, player5].map(p => p.agentName),
    // moderator=moderator,
    false,
    "all",
    "round",
